...
export async function generateMetadata({ params }: { params: Promise<{ locale: string }> }): Promise<Metadata> {
  ...
  const title = `${t('pages.reisepakete')} | MagicFewo`
  ...
  return (
    <div className="py-16">
      <div className="container mx-auto px-4">
        <Breadcrumbs items={[{ label: 'Reisepakete', href: '/reisepakete' }]} />
        <h1 className="text-4xl font-bold text-secondary mb-4">{t('pages.reisepakete')}</h1>
        <p className="text-gray-custom mb-12 max-w-2xl">
          Entdecken Sie unsere sorgfältig zusammengestellten Reisepakete für unvergessliche Erlebnisse.
          Jedes Paket wurde von unseren Experten kuratiert.
        </p>
              ...
              <div className="grid md:grid-cols-2 gap-6">
                <div className="relative overflow-hidden min-h-[300px]">
                  ...
                  <div className="absolute top-4 left-4">
                    <div className="bg-primary text-white px-4 py-2 rounded-full text-sm font-medium">Bestseller</div>
                  </div>
                </div>
                ...
                <div className="p-6">
                  ...
                  <div className="flex items-center gap-4 mb-4">
                    ...
                    <div className="flex items-center">
                      ...
                      <span className="text-gray-600">{pkg.groupSize} Personen</span>
                    </div>
                  </div>
                  ...
                  <div className="flex items-center mb-4">
                    ...
                    <span className="ml-2 text-sm text-gray-600">({pkg.reviews} Bewertungen)</span>
                  </div>

                  <p className="text-gray-600 mb-6">{pkg.description}</p>

                  <div className="space-y-2 mb-6">
                    <h3 className="font-semibold text-secondary">Highlights:</h3>
                  ...
                  <div className="flex items-center justify-between pt-4 border-t border-gray-100">
                    <div>
                      <span className="text-gray-500 text-sm">ab</span>
                      <span className="text-primary font-bold text-3xl ml-2">{pkg.price} €</span>
                      <span className="text-gray-500 text-sm ml-1">pro Person</span>
                    </div>
